...
public class CustomerRepository {
	...
	private static final RowMapper<Customer> customerRowMap = (rs, i) -> {
	...
	public Customer save(Customer customer) {
		...
		if (customer.getId() == null) {
			...
			jdbcTemplate.update(
					"UPDATE customers SET first_name=:firstNmae, last_name=:lastName WHERE id=:id", param);
		}
		return customer;
	}
